...
<div><img src="<?php echo base_url();?>public/images/to_top_icon.png" width="75px" height="75px" id="to_top_btn"/></div>

<div class="container">
    <div class="error_message" id="validate_url"><?php echo $message;?></div>
    <div class="start_dashboard_container">
        <a id="admin_start_dashboard_btn" href="#dashboard_location_1" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_1')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_2" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_2')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_3" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_3')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_4" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_4')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_5" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_5')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_6" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_6')?></a>
        <a id="admin_start_dashboard_btn" href="#dashboard_location_7" class="btn btn-default btn-lg"><?php echo $this->lang->line('office_7')?></a>
    </div>
    <?php //echo //$message;
        ...
        <div class="panel panel-primary">
            <a class="accordion-toggle" data-toggle="collapse" data-parent="#addEntry_container" href="#add_new_entry">
                <div class="panel-heading">
                    <h4 class="panel-title">Admin Dashboard: Add Entry</h4>
                </div>
            </a>
            <div id="add_new_entry" class="panel-collapse collapse">
                <div class="panel-body">
                    ...
                    <div class="form-group"><?php echo form_dropdown('add_category',$add_category,'1',$add_category_attribute);?></div>
                    ...
                    <div class="form-group"><?php echo form_checkbox($add_locationAll);?>All</div>
                    <div class="form-group"><?php echo form_checkbox($add_location1);echo $this->lang->line('office_1')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location2);echo $this->lang->line('office_2')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location3);echo $this->lang->line('office_3')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location4);echo $this->lang->line('office_4')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location5);echo $this->lang->line('office_5')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location6);echo $this->lang->line('office_6')?></div>
                    <div class="form-group"><?php echo form_checkbox($add_location7);echo $this->lang->line('office_7')?></div>
    ...
    <?php
    for($j=1;$j<=count($adminDashboardEntries);$j++){
        $currentDashboardEntries = $adminDashboardEntries[$j];
    ?>

    <table id="dashboard_table" class="dashboard_table" data-locationid="<?php echo $j;?>">
        <thead>
        <tr class="dashboard_header" id="dashboard_location_<?php echo $j;?>">
            <th class="id_col" style="display: none;">ID</th>
            <th class="office_location_col" colspan="2"><?php echo $this->lang->line('office_'.$j)?> Office</th>
        ...
        <tbody>
        <?php if(!empty($currentDashboardEntries)){
            for($i=1;$i<=count($currentDashboardEntries);$i++){
